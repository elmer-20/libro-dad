\chapter{CEPREUNA 2024-I Primera Etapa}
...
% (Dejar aquí el gráfico)
	\begin{center}
	\includegraphics[width=7.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/geo1c24-I.png}
	\end{center}
...
\textbf{Solucionario:}\\
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=6.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/geo1c24-Ir.png}
	\end{minipage}
\end{center}
\vspace{6mm}
...
\begin{center}
	\includegraphics[width=7.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/geo2c24-I.png}
\end{center}
...
\textbf{Solucionario:}\\
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=6.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/geo2c24-Ir.png}
	\end{minipage}
\end{center}
\vspace{6mm}
...
\begin{minipage}{0.45\textwidth}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=6.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/geo3c24-I.png}
	\end{minipage}
\end{center}
\vspace{6mm}
...
\begin{enumerate}
	...
	% (Dejar aquí el gráfico)
		\begin{center}
			\includegraphics[width=5.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/trigonometria2c24-I.png}
		\end{center}
	...
	\textbf{Solucionario:}\\
	\begin{center}
	\includegraphics[width=6.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/trigonometria2c24-Ir.png}
	\end{center}
	...
	\textbf{Solucionario:}\\
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=6.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/trigonometria3c24-Ir.png}
		\end{minipage}
	\end{center}
	\vspace{6mm}
	...
	\end{minipage}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=7.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/trigonometria4c24-Ir.png}
		\end{minipage}
	\end{center}
	\vspace{6mm}
...
% (Dejar aquí el gráfico)
\begin{center}
	\includegraphics[width=7.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/Fisica1c2024-I.png}
\end{center}
...
% (Dejar aquí el gráfico)
\begin{center}
	\includegraphics[width=7.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/Fisica2c2024-I.png}
\end{center}
...
\item Un tronco de madera de $8\,m^{3}$ de volumen flota en agua salada de densidad $1200\,kg/m^{3}$. Si el volumen emergente es de $2\,m^{3}$, determine la densidad de la madera.
	...
	\begin{center}
	\includegraphics[width=7.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/Fisica3c2024-I.png}
	\end{center}
...
\begin{center}
	\includegraphics[width=7.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/Fisica4c2024-I.png}
\end{center}
...
\textbf{Solucionario:}\\
\begin{center}
	\includegraphics[width=7.4 cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/quimica4c24-Ir.png}
\end{center}
...
\begin{tikzpicture}[x=1.7cm,y=1cm,>=Stealth]
...
\]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=6.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/rm2c24-Ir.png}
	\end{minipage}
\end{center}
\vspace{6mm}
...
\begin{center}
	\includegraphics[width=5.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/rm6c24-I.png}
\end{center}
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=7.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/soc/geo1c24-I.png}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=6.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/soc/geo2c24-I.png}
	\end{center}
	...
	\textbf{Solucionario:}\\
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=6.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/soc/geo2c24-Ir.png}
		\end{minipage}
	\end{center}
...
\begin{enumerate}
	...
	\begin{center}
	\includegraphics[width=7.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/soc/fisica1c24-I.png}
	\end{center}
