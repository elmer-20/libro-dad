...
\begin{enumerate}
	...
	\begin{flalign*}
		...
		&\quad \therefore q = \dfrac{31^2 - 1}{8} = 120 &
	\end{flalign*}
...
\begin{enumerate}[resume]
	...
	$$\therefore \left(\dfrac{b^d c^a}{(1-k)}\right) (a^c.c^a) = \left(\dfrac{1-k}{1-k}\right) (2) = 2$$
	...
	\[
	|A|
	= \left(\dfrac{3}{2}\right)^3 \bigl(0 + 1 + 1 - 0 - 0 - 0\bigr)
	\]
...
\begin{enumerate}[resume]
	...
	\begin{center}
		\begin{minipage}{0.45\textwidth}
			...
			$\sen \alpha=\dfrac{3}{7}$\\
			$x=30$.$\cos\alpha$\\
			$x=30$.$\dfrac{2\sqrt{10}}{7}=\dfrac{60\sqrt{10}}{7} $
			\vspace{6mm}
		\end{minipage}
		\hfill
		\begin{minipage}{0.45\textwidth}
...
\textbf{Solucionario:}\\[1mm]
	...
	\begin{minipage}{0.45\textwidth}
		...
		$M=\dfrac{144+25}{13}=\dfrac{13^2}{13}=13$
		\vspace{6mm}
	\end{minipage}
	\hfill
	\begin{minipage}{0.45\textwidth}
...
\begin{enumerate}[resume]
	...
	\item Una función de onda transversal esta dada por $\psi(x,t)=20\cos(\dfrac{\pi}{8}x-6\pi t)$ donde x y $\psi$ etan en centimetros, t en segundos .Calcule la rapidez de propagación y el periodo de osilación.
	\begin{enumerate}[label=\alph*)]
		\item $30 cm/s ; 2s.$
...
\begin{enumerate}[resume]
	...
	Traza de $A = \dfrac{5}{4} + \dfrac{3}{4} = 2$
...
\begin{enumerate}[resume]
	...
	$C_{8}^{10} = \dfrac{10!}{(10-8)! \cdot 8!} = \dfrac{10 \times 9 \times 8!}{2! \cdot 8!} = 45$
