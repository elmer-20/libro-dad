...
\begin{enumerate}
	...
	\begin{tikzpicture}[overlay, remember picture]
		\node at (10, 1.5) {\includegraphics[width=0.7\textwidth]{BIO_PREG1_GEOMETRIA_SOLUCION}};
	\end{tikzpicture}
...
\begin{enumerate}
	...
	\item Pregunta de Aritmética para Sociales...
	\begin{enumerate}[label=\alph*)]
		\item A
		\item B
		\item C
...
\begin{enumerate}[resume]
	...
	\item Pregunta de Álgebra para Sociales...
	\begin{enumerate}[label=\alph*)]
		\item A
		\item B
		\item C
...
\begin{enumerate}[resume]
	...
	\item Pregunta de Geometría para Sociales...
	\begin{enumerate}[label=\alph*)]
		\item A
		\item B
		\item C
...
\begin{enumerate}[resume]
	...
	\item Pregunta de Trigonometría para Sociales...
	\begin{enumerate}[label=\alph*)]
		\item A
		\item B
		\item C
...
\begin{enumerate}[resume]
	...
	\item Pregunta de Física para Sociales...
	\begin{enumerate}[label=\alph*)]
		\item A
		\item B
		\item C
...
\begin{enumerate}[resume]
	...
	\item Pregunta de Química para Sociales...
	\begin{enumerate}[label=\alph*)]
		\item A
		\item B
		\item C
...
\begin{enumerate}
	...
	\item Pregunta 1 de Aritmética - Etapa 2...
	\begin{enumerate}[label=\alph*)]
		\item A
		\item B
		\item C
