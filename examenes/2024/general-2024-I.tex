\chapter{Examen General 2024-I Primera Etapa}
...
\begin{enumerate}
	...
	\textbf{Solucionario:}\\
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=6cm]{imagenes/general2024-I/etapa1/ing/fisica1g24-I .png}
		\end{minipage}
	\end{center}
	\vspace{6mm}
	...
	\begin{center}
		\includegraphics[width=6.5cm]{imagenes/general2024-I/etapa1/ing/fisica2g24-I.png}
	\end{center}
...
\subsection*{Razonamiento Matematico}
...
\begin{enumerate}[resume]
	...
	La idea central del conjunto gira en torno a la observación y su relación con la investigación y el conocimiento. Las oraciones a), b), c) y e) se vinculan directamente con ese tema. En cambio, la oración d) se refiere a una condición fisiológica de los sentidos, alejándose del eje temático principal. Por eso, la oración a eliminar es la d).
...
\begin{enumerate}[resume]
	...
	La palabra \textit{mefítico} se refiere a algo que despide gases o vapores nocivos, pestilentes o que hacen difícil la respiración. Por ello, su sinónimo más adecuado es \textit{irrespirable}.
...
\begin{enumerate}[resume]
	...
	El texto plantea la dificultad de establecer el límite entre una simple mezcla química y un organismo vivo. Esa interrogante lleva necesariamente a precisar el concepto de vida. Por ello, la biología se ve obligada a definir lo que es la vida.
...
\begin{enumerate}
	...
	\item ¿Cuál es el número de 5 cifras que multiplicado por 22 nos da un producto cuyas cifras son todas 8? De cómo respuesta la suma de cifras del número.
	\begin{enumerate}[label=\alph*)]
		\item 14
		\item 12
		\item 16
