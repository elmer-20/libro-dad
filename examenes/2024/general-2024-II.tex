...
\vspace*{\fill}
\begin{center}
	{\Huge\bfseries Examen General 2024-I Segunda Etapa}
\end{center}
\vspace*{\fill}
...
\begin{enumerate}
	...
	\item De las siguientes proposiciones,¿Cuáles son equivalentes entre si ?
	...
	\begin{enumerate}[label=\alph*)]
		...
		\item II y III
		\item I y III
		\item No son equivalentes entre si
	\end{enumerate}
	...
	\item En un barco habían 180 personas, ocurre un naufragio y, de los sobrevivientes, $\frac{2}{5}$ fuman, $\frac{3}{7}$ son casados y $\frac{2}{3}$ son ingenieros. ¿Cuántas personas sobrevivieron en dicho accidente?
	...
	\begin{tikzpicture}[font=\normalsize]
		...
		\node (F) at (0, 1.5) {$\text{Fuman } \frac{2}{5} S \implies S=\mathring{5}$};
		\node (C) at (0, 0) {$\text{Casados } \frac{3}{7} S \implies S=\mathring{7}$};
		\node (I) at (0, -1.5) {$\text{Ingenieros } \frac{2}{3} S \implies S=\mathring{3}$};
	...
	\noindent $\frac{2^{6}-1}{2-1} \cdot \frac{a^{2}-1}{a-1} \cdot \frac{b^{2}-1}{b-1} = 3 (2^5 . a.b)$
	...
	\item Si $N$ se eleva al cuadrado y se le resta la unidad, es divisible entre 8, Ademas el \text{MCM} de $N$ y el cociente obtenido es $3720$. Halle dicho cociente.
	\begin{enumerate}[label=\alph*)]
		\item 110
		\item 98
		\item 108
	...
	\textbf{Solucionario:}\\
	\begin{flalign*}
		&\quad N^2 - 1 = \mathring{8} \text{ donde } q = \frac{N^2 - 1}{8} & \\
		&\quad \text{MCM}(N, q) = 3720 & \\
		&\quad \text{MCM} \underbrace{\left(N, \frac{N^2 - 1}{8}\right)}_{\text{PESI}} =\frac{N(N^2 - 1)}{8} = 3720 & \\
		&\quad \implies N(N^2 - 1) = 8(3720) \implies N = 31 & \\
		&\quad \therefore q = \frac{31^2 - 1}{8} = 120 &
	\end{flalign*}
...
\begin{enumerate}
	...
	\item  \text{Si el rango de la función } y = $\frac{4x}{x^2+1}$ \text{ es el intervalo } [a, b], \text{ calcule } $a^2 + b^2$.
	...
	\begin{flalign*}
		&\quad \text{Dom } g(x) = \mathbb{R}; \quad y = \frac{4x}{x^2+1} & \\
		&\quad yx^2 - 4x + y = 0 & \\
	...
	\begin{flushleft}
		...
		\[
		\text{Calcule } 
		\left( \frac{b^{\,c}\, d^{\,a}}{1 - K} \right)(a^{\,c} c^{\,a})
		\]
	\end{flushleft}
	...
	$$\therefore \left(\frac{b^d c^a}{(1-k)}\right) (a^c.c^a) = \left(\frac{1-k}{1-k}\right) (2) = 2$$
	
	\vspace{6mm}
	
	\item Resuelva la siguiente ecuasion:\\
	$$\log_x(5-x) + \frac{1}{\log_{(x+2)} x} = \log_x 6$$
	...
	\begin{aligned}
		...
		a_{12} = 3 - a_{12} &\Rightarrow a_{12} = \frac{3}{2} \\[6pt]
		a_{13} = 3 - a_{13} &\Rightarrow a_{13} = \frac{3}{2} \\[6pt]
		a_{21} = 3 - a_{21} &\Rightarrow a_{21} = \frac{3}{2}
	\end{aligned}
	\]
	...
	\[
	|A|
	= \left(\frac{3}{2}\right)^3 \bigl(0 + 1 + 1 - 0 - 0 - 0\bigr)
	\]
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=5cm]{imagenes/general2024-I/etapa2/ing/Enunciado-1.png}\par\vspace{2cm}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=5cm]{imagenes/general2024-I/etapa2/ing/Pgeometria1.png}\par\vspace{2cm}
	\end{center}
	...
	\item En un cono circular recto de 9cm de altura y 15 cm de radio, se inscribe un cilindro circular recto de 5cm de radio tal que una de sus bases esta sobre la base del cono. Calcule el volumen del cilindro.
	\begin{enumerate}[label=\alph*)]
		\item 120 $\pi cm^3$
		\item 130 $\pi cm^3$
		\item 140 $\pi cm^3$
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=5cm]{imagenes/general2024-I/etapa2/ing/problema-2.png}
		\end{minipage}
	\end{center}
	...
	\begin{center}
		\begin{minipage}{0.45\textwidth}
			...
			$\therefore$ El nuevo Ancho del agua $= 8+8=16$	
			\vspace{6mm}
		\end{minipage}
		\hfill
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=7cm]{imagenes/general2024-I/etapa2/ing/problema 3 geometris.png}
		\end{minipage}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=5.5cm]{imagenes/general2024-I/etapa2/ing/probgeometria4.png}\par
		\vspace{2cm}
	\end{center}
	...
	$
	= 5(\pi r) + \frac{2\pi R\,\theta}{360^\circ}
	$
	
	$
	= 5\!\left(\frac{2\pi\left(\tfrac{R}{2}\right)}{2}\right)
	+ \frac{2\pi R(60^\circ)}{360^\circ}
	$
	
	$
	= \frac{5\pi R}{2} + \frac{\pi R}{3}
	$
...
\begin{enumerate}
	...
	\begin{enumerate}[label=\alph*)]
		\item $\frac{60}{7}m$
		\item $\frac{40}{7}m$
		\item $\frac{60\sqrt{10}}{7}m$
		\item $\frac{50\sqrt{10}}{7}m$
		\item $\frac{45\sqrt{10}}{7}m$
	\end{enumerate}
	...
	\begin{center}
		\begin{minipage}{0.45\textwidth}
			...
			$\sen \alpha=\frac{3}{7}$\\
			$x=30$.$\cos\alpha$\\
			$x=30$.$\frac{2\sqrt{10}}{7}=\frac{60\sqrt{10}}{7} $
			\vspace{6mm}
		\end{minipage}
		\hfill
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/ing/trigonometria-1.png}
		\end{minipage}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/ing/trigonometria-2.png}
	\end{center}
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/ing/trigonometria-2.2.png}
		\end{minipage}
	\end{center}
...
\begin{center}
	\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/ing/trigonometria-3.png}
\end{center}
...
\textbf{Solucionario:}\\
	...
	\begin{center}
	\begin{minipage}{0.45\textwidth}
		$\cos(\overbrace{360°-\theta}^{\text{$IV_c$}})=\cos\theta=\frac{12}{13}$\\
		$\cos(\overbrace{180°-\alpha}^{\text{$II_c$}})=-\cos\alpha=\frac{5}{13}$\\
		Remplazando: \\
		$M= 12 \cos\theta-5\cos\alpha$\\
		$M=12(\frac{12}{13})-5(\frac{-5}{13})$\\
		$M=\frac{144+25}{13}=\frac{13^2}{13}=13$
		\vspace{6mm}
	\end{minipage}
	\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/ing/trigonometria-3.3.png}
	\end{minipage}
\end{center}
...
\vspace{6mm}
	...
	$K= \frac{\sen\alpha-2}{\sen\alpha+2},\alpha \in  III_c$\\
...
\vspace{2mm}
\textbf{Solucionario:}\\
$K= \frac{\sen\alpha+2}{\sen\alpha+2}-\frac{4}{\sen\alpha+2}$\\
$K= 1-\frac{4}{\sen\alpha+2}$\\
$III_c \rightsquigarrow -1< \sen\alpha < 0  $\\
$1< \sen\alpha+2 < 2$\\
$1>\frac{1}{5\alpha+2}>\frac{1}{2}$\\
$-4<\frac{-4}{5\alpha+2}<-2 $\\
$-3<1-\frac{4}{5\alpha+2}<-1 $\\
$-3<K<-1 $\\
	\fbox{
$\langle-3;-1\rangle$
}
...
\begin{enumerate}
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/ing/fisica-1.png}
		\end{minipage}
	\end{center}
	...
	\begin{center}
		\begin{minipage}{0.45\textwidth}
		$I \div II$\\
		$\frac{T\sen\theta}{T\cos\theta}=\frac{Eq}{mg}$\\
		$\tan\theta=\frac{(5)(10)}{(5)(10)}=1$\\
			\fbox{
		$\theta=45°$
	}
			\vspace{6mm}
		...
		\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/ing/fisica-1.1.png}
		\end{minipage}
	\end{center}
	...
	\item Una paetícula con +3mC de carga que tiene una velocidad de $\vec{v}=(\hat{J}+2\hat{k})10^3m/s$, esta dentro de un campo magnético $\vec{B}=2\hat{i}T$. Calcule la fuerza magnética sobre la partícula.
	\begin{enumerate}[label=\alph*)]
	...
	$P = \frac{(6,63 \times 10^{-34} \, \text{J}\cdot\text{s})(6 \times 10^{15} \, \text{Hz})}{3 \times 10^8 \, \text{m/s}}$
	...
	\item Una función de onda transversal esta dada por $\psi(x,t)=20\cos(\frac{\pi}{8}x-6\pi t)$ donde x y $\psi$ etan en centimetros, t en segundos .Calcule la rapidez de propagación y el periodo de osilación.
	\begin{enumerate}[label=\alph*)]
		\item $30 cm/s ; 2s.$
		\item $48 cm/s ; \frac{1}{3}s.$
		\item $40 cm/s ; \frac{1}{4}s.$
		\item $24 cm/s ; \frac{1}{3}s.$
		\item $20 cm/s ; 1s.$
	\end{enumerate}
	\textbf{Respuesta correcta:} b)
	...
	\textbf{Solucionario:}\\
		...
		$\phantom{\psi} = 20 \cos\left(\frac{\pi}{8}x - 6\pi t\right)$
		
		\fbox{$A = 20 \, \text{cm}$}
		
		$k = \frac{\pi}{8} \, \text{cm}^{-1}$
		
		$\omega = 6\pi \, \text{rad/s}$
		
		$v = \frac{\omega}{k} = \frac{6\pi \, \text{rad/s}}{\frac{\pi}{8} \, \text{cm}^{-1}} = 48 \, \text{cm/s}$
		
		$T = \frac{2\pi}{\omega} = \frac{2\pi}{6\pi} =$ \fbox{$ \frac{1}{3} \, \text{s}$}
...
\begin{enumerate}
	...
	\item Se dispone de gas helio a 2400 mmHg contenido en un recipiente cúbico. Si dicho gas se traslada a otro cubo cuya arista es la cuarta parte de la arista del primero y su temperatura se reduce en un 60\% ,¿cúal será su presión final en mmHg?
	\begin{enumerate}[label=\alph*)]
		\item 75000
		\item 61440
		\item 64040
	...
	\textbf{Solucionario:}\\
		...
		\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/ing/quimica-1.png}
		\vspace{6mm}
		\end{minipage}
		\hfill
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=2.5cm]{imagenes/general2024-I/etapa2/ing/quimica-1.1.png}
		\end{minipage}
	\end{center}
	...
	$\frac{(2400)(a^3)}{T} = \frac{P_2 \cdot \left(\frac{a}{4}\right)^3}{0,4T}$
	
	$\Rightarrow (0,4T)(2400)(a^3) = \frac{P_2 (a^3) T}{64}$
	...
	$m = \frac{P_{eq} \cdot I \cdot t}{96\,500}$ , despejando tiempo $t = \frac{96\,500 \cdot m}{P_{eq} \cdot I}$\\
	
	$t = \frac{(96\,500)(5)}{\left( \frac{56}{3} \right) \cdot 120}$ $\Rightarrow$ \fbox{$ t = 215,4 \, \text{s}$}
	
	
		\item ¿Qué masa de oxido de calcio se obtendrá si se calcína 1 tonelada de caliza, cuyo contenido de $C_aCO_3$ es del $62\%?  (C_a = 40;C=12;O=16)$\\
...
$S = \frac{20(21)(41)}{6} = 10(7)(41) = $\fbox{$2870$ monedas.}
...
\vspace{6mm}
	...
	\item En el cuadrado ABCD, cuyo lado, mide 4cm, determine el área de la region sombreada, siendo O centro de la circunferencia.
	
		\begin{center}
		\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/ing/rm5.png}\par\vspace{2cm}
	\end{center}
...
\textbf{Solucionario:}\\
	...
	\begin{center}
	\begin{minipage}{0.45\textwidth}
	Al trazar $\overline{OM}$ y  $\overline{ON}$, se observan regiones equivalentes a cuyas áreas le asignamos valores a y b\\
	piden $A_{somb}=2a+2b=??$\\
	Pero del grafico $a+b=A_{DOND}=\frac{\pi 2^2}{4}= \pi cm^2$\\
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/ing/rrm5.png}
	\end{minipage}
	\end{center}
...
Suma: $S_{100} = \frac{(4 + 301)100}{2} = 305 \times 50 = 15250$.\\
...
\begin{enumerate}
	...
	$2$ \hspace{7.5mm} $4$ \\
	Luego $5a - 2b \implies 5(2) - 2(4) = 10 - 8 = 2$
	...
	$P = \dfrac{24 \times 1}{10 \times 11 \times 12} = \dfrac{2}{110} = \dfrac{1}{55}$
...
\begin{enumerate}
	...
	$2A \cdot 2I = \begin{pmatrix} 5 & -3 \\ 3 & 3 \end{pmatrix} \Rightarrow A = \begin{pmatrix} \frac{5}{4} & \frac{-3}{4} \\ \frac{3}{4} & \frac{3}{4} \end{pmatrix}$\\
	Traza de $A = \frac{5}{4} + \frac{3}{4} = 2$
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/bio/geo1g24-II.png}
	\end{center}
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/bio/geo1g24r-II.png}
		\end{minipage}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/bio/geo2g24-II.png}
	\end{center}
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/bio/geo2g24-IIr.png}
		\end{minipage}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/bio/geo3g24-II.png}
	\end{center}
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/bio/geo3g24-IIr.png}
		\end{minipage}
	\end{center}
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/bio/trigo1g24-II.png}
	\end{center}
	...
	$\dfrac{\frac{2\sqrt{2}}{\sqrt{3}}}{1 - \frac{2}{3}} = \dfrac{x + \sqrt{2}}{\sqrt{3}}$
	...
	$\text{ctg} \theta = \frac{6\sqrt{2}}{\sqrt{2}} = \fbox{6}$
	...
	\begin{center}
		\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/bio/trigo2g24-II.png}
	\end{center}
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/bio/trigo2g24-IIr.png}
		\end{minipage}
	\end{center}
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=5.5cm]{imagenes/general2024-I/etapa2/bio/fisica1g24-IIr.png}
	\end{center}
...
\begin{enumerate}
	...
	$ \varepsilon = \dfrac{hc}{\lambda} = \dfrac{6,626 \times 10^{-34}\text{ J}\cdot\text{s} \times 3 \times 10^8\text{ m/s}}{700\text{ nm} \times \frac{1\text{ m}}{10^9\text{ nm}}} $\\
	...
	$ \text{V}_{\text{O}_2} = \dfrac{(3\text{ L})(\frac{5}{2}\text{ V})}{1\text{ V}} = 7,5\text{ L} $
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/bio/rm2g24-II.png}
	\end{center}
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=5.5cm]{imagenes/general2024-I/etapa2/bio/rm2g24-IIr.png}
		\end{minipage}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=3.5cm]{imagenes/general2024-I/etapa2/bio/rm5g24-II.png}
	\end{center}
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=3.5cm]{imagenes/general2024-I/etapa2/bio/rm5g24-IIr.png}
		\end{minipage}
	\end{center}
...
\begin{enumerate}
	...
	\item \textbf{TEXTO}\\
	En Estados Unidos hace años se detectaba un solo caso de cáncer a la piel por cada mil quinientos habitantes. Antes, la gente sana relacionada con la piel bronceada y la más elegante, presumía sus andanzas por los balnearios y las playas. Todo esto cambió. En lugar de tenderse en la playa, uno debe buscar un lugar sombreado, a donde los rayos de sol lleguen de manera indirecta. Además, conviene utilizar cremas protectoras, según lo sugiere el Instituto de cáncer de Estados Unidos. \\
...
\begin{enumerate}
	...
	B: I'm sorry hear that. You \underline{\hspace{2cm}} go to the doctor.
	\begin{enumerate}[label=\alph*)]
		\item should
		\item don't should
		\item are
...
\begin{enumerate}
	...
	$\therefore\ \text{La fracción de la población $P$ es } \dfrac{1}{6}.$
...
\begin{enumerate}
	...
	\begin{aligned}
		M &= \frac{2^{x+3}+4^{x+1}}{8^x+3}\\
		&= \frac{2^x\cdot 2^3 + 2^{2x+2}}{2^{3x}+3}\\
		&= \frac{2^x\cdot 8 + (2^x)^2\cdot 2^2}{(2^x)^3+3}\\
		&= \frac{3\cdot 8 + 3^2\cdot 4}{3^3+3}\\
		&= \frac{24+36}{30}=\frac{60}{30}=2
	\end{aligned}
	$
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/soc/geometria1g24-II.png}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=6.5cm]{imagenes/general2024-I/etapa2/soc/geometria2g24-II.png}
	\end{center}
	...
	\textbf{Solucionario:}\\
	\begin{center}
		\includegraphics[width=6.5cm]{imagenes/general2024-I/etapa2/soc/geometria2g24-IIr.png}
	\end{center}
	
	De la figura se tiene:\\
	$a^\circ+b^\circ+c^\circ = 360^\circ-d^\circ+360^\circ-e^\circ$\\
	$a^\circ+b^\circ+c^\circ+d^\circ+e^\circ = 720^\circ$
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=6.5cm]{imagenes/general2024-I/etapa2/soc/trigo1g24-II.png}
	\end{center}
	\begin{enumerate}[label=\alph*)]
		\item 1
		\item $\dfrac{3}{2}$
	...
	\textbf{Solucionario:}\\
	\begin{center}
		\includegraphics[width=0.6\textwidth]{imagenes/general2024-I/etapa2/soc/trigo1g24-IIr.png}
	\end{center}
	...
	$
	M=\dfrac{4\left(-\frac{1}{2}\right)+1}{-\frac{1}{2}}
	$
	
	$
	M=\dfrac{-2+1}{-\frac{1}{2}}=2
	$
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=0.4\textwidth]{imagenes/general2024-I/etapa2/soc/fisica1g24-II.png}
	\end{center}
	...
	$R_B = \dfrac{1000\sqrt{3}}{3}\,N = \dfrac{\sqrt{3}}{3}\,kN$
	...
	\begin{center}
		\includegraphics[width=5cm]{imagenes/general2024-I/etapa2/soc/fisica2g24-IIr.png}
	\end{center}
	...
	\begin{aligned}
		...
		&= \dfrac{400\left(\frac{1}{2}\right)(40)}{40} \\
		&= 200\,W
	\end{aligned}
	$
...
\begin{enumerate}
	...
	\begin{itemize}
		\item La mezcla es una reunión de 2 o mas componentes, no se puede diferenciar sus componentes a simple vista. El oro de 18 kilates es una mezcla de oro y plata.
		...
		\item Es un elemento quimico que se encuentra en la naturaleza, como los metales nativos, ejemplo Cobre, Fierro, etc.)
	\end{itemize}
...
\begin{enumerate}
	...
	\item Existen pacientes que sufren de amnesia, los cuales a veces son incapaces de recordar un número telefónico, una dirección o el nombre de una persona, pero si pueden recordar como resolver rompecabezas complejos en un tiempo normal, lo cual sería un indicador de que no se encuentra dañada la memoria:
	\begin{enumerate}[label=\alph*)]
		\item semántica.
		\item procedimental.
		\item episódica.
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=4.5cm]{imagenes/general2024-I/etapa2/soc/rm1g24-II.png}
	\end{center}
	...
	$\therefore$ Ambos relojes volverán a marcar la misma hora dentro de $2,5$ días.
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			...
			$=\frac{\pi 4^2}{4}-\frac{4 \text{x} 4}{2}$\\
			$= 4 \pi -8$\\
			$=4(\pi -2)u^2$\\
	...
	$C_{8}^{10} = \frac{10!}{(10-8)! \cdot 8!} = \frac{10 \times 9 \times 8!}{2! \cdot 8!} = 45$
