\chapter{Examen General 2024-I Segunda Etapa}
...
\begin{enumerate}
	...
	\textbf{Solucionario:}\\
		...
		\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=6.5cm]{imagenes/general2024-I/etapa2/ing/quimica-1.png}
		\vspace{6mm}
		\end{minipage}
		\hfill
		\begin{minipage}{0.45\textwidth}
...
\vspace{6mm}
	...
	\item En el cuadrado ABCD, cuyo lado, mide 4cm, determine el área de la region sombreada, siendo O centro de la circunferencia.
		...
		\begin{center}
		\includegraphics[width=5cm]{imagenes/general2024-I/etapa2/ing/rm5.png}\par\vspace{2cm}
	\end{center}
...
\textbf{Solucionario:}\\
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=5cm]{imagenes/general2024-I/etapa2/ing/rrm5.png}
	\end{minipage}
	\end{center}
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/soc/geometria1g24-II.png}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/soc/geometria2g24-II.png}
	\end{center}
	...
	\textbf{Solucionario:}\\
	\begin{center}
		\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/soc/geometria2g24-IIr.png}
	\end{center}
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/soc/trigo1g24-II.png}
	\end{center}
	\begin{enumerate}[label=\alph*)]
		\item 1
		\item $\dfrac{3}{2}$
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=7cm]{imagenes/general2024-I/etapa2/soc/fisica2g24-IIr.png}
	\end{center}
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=7.5cm]{imagenes/general2024-I/etapa2/soc/rm1g24-II.png}
	\end{center}
