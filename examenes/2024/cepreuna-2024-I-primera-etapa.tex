\thispagestyle{empty}
\addcontentsline{toc}{chapter}{EXAMEN CEPREUNA 2024-I}
\addcontentsline{toc}{section}{Primera Etapa}


\newpage
%\thispagestyle{empty} % Para que no tenga número de página
\mbox{}               % Crea un objeto invisible
\newpage
...
\begin{enumerate}
	...
	\begin{itemize}
		\item[I.] $P(A)$ tiene cuatro elementos
	...
	% --- Pregunta 3 ---
	\item Ocho obreros realizan una obra en 20 días. Después de 5 días de trabajo, se retiran tres obreros. ¿Con cuántos días de atraso se termina la obra?
	\begin{enumerate}[label=\alph*)]
		\item 24 días
		\item 25 días
		\item 16 días
	...
	Como después de 5 días se retiraron tres obreros $\Rightarrow $ ocho obreros lo harán 15 días.\\
	...
	$X = \dfrac{(15)(8)}{5} = 24$ días.\\
	$\leadsto$ retraso \fbox{$= 24 - 15 = 9$ días}
	
	\vspace{6mm}
	
	% --- Pregunta 4 ---
	\item A una fiesta de promoción asistieron 140 alumnos entre hombres y mujeres. Por cada tres mujeres hay cuatro hombres. Si se retiran 20 parejas, ¿Cuál es la razón entre el número de mujeres y el número de hombres que se quedan en la fiesta?
	\begin{enumerate}[label=\alph*)]
		\item $\dfrac{3}{4}$
		\item $\dfrac{2}{3}$
		\item $\dfrac{3}{2}$
	...
	$H_0 + M_0 = 140 \quad \dots (I)$\\
	
	$\dfrac{M_0}{H_0} = \dfrac{3}{4} \Rightarrow \left. \begin{array}{l} M_0 = 3K \\ H_0 = 4K \end{array} \right\} (II)$\\
	...
	$\dfrac{M}{H} = \dfrac{40}{60} =$\fbox{$ \dfrac{2}{3} $}
...
\begin{enumerate}[resume]
	...
	\end{tabular} \\
	\\
	$\therefore 2^{x-1} = 128 = 2^7 \Rightarrow x = $\fbox{$8$ días}
	...
	Utilizando la Regla de Ruffini para evaluar el polinomio.
	...
	\end{tabular} \\
	\\
	$\therefore P(1-\sqrt{3}) =$\fbox{$ 9-3\sqrt{3}$}
	...
	\[
	\dfrac{a^{5p-5} - b^{4p-4}}{a^{p-4} - b^{p-5}}
	\]
	\begin{enumerate}[label=\alph*)]
		\item 7
		\item 8
	...
	$\dfrac{5p-5}{p-4} = \dfrac{4p-4}{p-5}$ por ser C.N.
	...
	$\therefore \# \text{términos} = \dfrac{5(9)-5}{9-4} = \dfrac{40}{5} =$\fbox{$ 8$}
...
\item En un terreno de cultivo de forma rectangular, se toma una porción de forma triangular para la siembra de maíz. En dicha porción, una de sus esquinas  " O " es el centro del terreno de cultivo. ¿Cuál es el ancho del terreno si su diagonal es 600 m?
...
\textbf{Solucionario:}
	...
	\begin{minipage}{0.45\textwidth}
		...
		$m\angle EAO = m\angle EOA = \theta $
		
		$\Rightarrow m\angle OED = 2\theta$
...
\item Un poste está sujeto al suelo con dos cables tensores. Si el cable de mayor longitud con el poste forma un ángulo de $30^\circ$, calcule la medida del ángulo formado entre los dos cables.

\begin{center}
	\includegraphics[width=3.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/geo2c24-I.png}
\end{center}
...
\textbf{Solucionario:}
	...
	\begin{center}
	\begin{minipage}{0.45\textwidth}
		En $\triangle BAC$ es notable $(30^\circ;60^\circ)$\\
		$\Rightarrow AC = 8\,m$\\
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=4.4cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/geo2c24-Ir.png}
	\end{minipage}
\end{center}
\vspace{6mm}
...
\begin{minipage}{0.45\textwidth}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=4.3cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/geo3c24-I.png}
	\end{minipage}
\end{center}
\vspace{6mm}
...
\begin{enumerate}[resume]
	...
	$f(x)=\dfrac{2\cdot 2}{2\cdot \operatorname{Sen}x\,\cdot \operatorname{Cos}x}
	...
	% (Dejar aquí el gráfico)
		\begin{center}
			\includegraphics[width=3cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/trigonometria2c24-I.png}
		\end{center}
	...
	\begin{center}
	\includegraphics[width=4.2cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/trigonometria2c24-Ir.png}
	\end{center}
	...
	\textbf{Solucionario:}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=4cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/trigonometria3c24-Ir.png}
		\end{minipage}
	\end{center}
	\vspace{6mm}
	...
	\end{minipage}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=4.8cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/trigonometria4c24-Ir.png}
		\end{minipage}
	\end{center}
	\vspace{6mm}
...
% (Dejar aquí el gráfico)
\begin{center}
	\includegraphics[width=5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/Fisica1c2024-I.png}
\end{center}
...
\textbf{Solucionario:}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/Fisica1c2024-Ir.png}
	\end{minipage}
\end{center}
\vspace{6mm}
...
% (Dejar aquí el gráfico)
\begin{center}
	\includegraphics[width=4.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/Fisica2c2024-I.png}
\end{center}
...
\textbf{Nota:}
\begin{itemize}
	\item $T$: tensión en la cuerda.
	\item $P_B = Mg$: peso del bloque.
	\item $m$: masa de la esfera.
	\item $M$: masa del bloque.
	\item $R$: radio de la trayectoria circular.
	\item $\omega$: rapidez angular de la esfera.
...
\item Un tronco de madera de $8\,m^{3}$ de volumen flota en agua salada de densidad $1,200\,kg/m^{3}$. Si el volumen emergente es de $2\,m^{3}$, determine la densidad de la madera.

	\begin{center}
	\includegraphics[width=5.6cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/Fisica3c2024-I.png}
	\end{center}
...
\textbf{Solucionario:}
	...
	\begin{minipage}{0.45\textwidth}
		...
		$E=P$\\
		$m_{\ell}g=m_{m}g$\\
		$\rho_{\ell}V_{\ell}\cancel{g} = \rho_{m}V_{m}\cancel{g}$\\
		
		$1,200(6)=\rho_{m}(8)$\\
		\fbox{$900\,kg/m^{3}=\rho_{madera}$}
		
		\vspace{6mm}
	\end{minipage}
	\hfill
	\begin{minipage}{0.45\textwidth}
		\includegraphics[width=2 cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/Fisica3c2024-Ir.png}
	\end{minipage}
\end{center}
\vspace{6mm}
...
\begin{center}
	\includegraphics[width=4.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/Fisica4c2024-I.png}
\end{center}
...
$n_1=$ índice de refracción del aire.

$n_2=$ índice de refracción del vidrio.

$n_3=$ índice de refracción del agua.

$\theta_1$: ángulo de incidencia en el aire.

$\theta_2$: ángulo de refracción en el vidrio.

$\theta_3=\theta$: ángulo de refracción en el agua.
...
$\dfrac{\cancel{3}}{\cancel{2}}\times\dfrac{4}{5}\times\dfrac{\cancel{2}}{\cancel{3}}=\dfrac{4}{3}\operatorname{sen}\theta_{3}$
...
$E=m_{total}\,c^{2}$ $\Longrightarrow$ $m_{total}=m_{e}+m_{p}=2(9.1\times10^{-28}\,g)$
...
$PV=nRT$ \qquad $n=\dfrac{w}{Pm}$

$PV=\dfrac{w}{Pm}RT$ \qquad $w=\dfrac{PV\,Pm}{RT}$

$Pm_{O_{2}}=32\,g/mol$

$w=\dfrac{(0.3\,atm)(82\,L)(32\,g/mol)}{\left(0.082\,\dfrac{atm\cdot L}{mol\cdot {}^\circ K}\right)(300^\circ K)}=$\fbox{$32\,g$}
...
\fbox{$3$-etil-$2,8$-dimetil-$7$-propil decano}
...
\begin{enumerate}[resume]
	...
	\item ¿Qué podría ocurrir si un paciente presenta deficiencia de linfocitos NK?
	\begin{enumerate}[label=\alph*)]
...
La definición corresponde a la \textbf{tasa bruta de natalidad}: nacimientos por cada 1,000 habitantes en un año.
...
\item  La cultura Paracas pertenece al periodo ................................ mientras que la cultura Wari perteneció al periodo ....................................
\begin{enumerate}[label=\alph*)]
	\item Horizonte temprano -- Horizonte medio
	\item Horizonte medio -- Intermedio tardío
	\item Arcaico temprano -- Intermedio tardío
	\item Arcaico tardío -- Formativo inicial
...
El ISC grava bienes específicos (por ejemplo combustibles). La \textbf{gasolina} está afecta al ISC.
...
\begin{center}
	\includegraphics[width=4.8cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/rm2c24-I.png}
\end{center}
...
Luego, el área máxima es

$A_{\max} = 15(1)(2-1) = $\fbox{$15 u^2$}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=4.8cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/rm2c24-Ir.png}
	\end{minipage}
\end{center}
...
\end{aligned}
$\\
Donde: $x=6$, $y=3$, el número será 63,

entonces el producto es: $6 \times 3=$\fbox{$18$}
...
$\boxed{\boxed{\boxed{2x+1}}}=21=\dfrac{6\times 7}{2}\ \Rightarrow\ \boxed{\boxed{2x+1}}=6$\\

$\boxed{\boxed{2x+1}}=6=\dfrac{3\times 4}{2}\ \Rightarrow\ \boxed{2x+1}=3$\\

$\boxed{2x+1}=3=\dfrac{2\times 3}{2}\ \Rightarrow\ 2x+1=2$\\

$\Rightarrow\ 2x=1$\\

$\Rightarrow\ x=\dfrac{1}{2}$\\

$\therefore\ \text{El valor de $x$ es }$\fbox{$\dfrac{1}{2}$}\\
...
\textit{El término central ocupa la posición:}

$\dfrac{81+1}{2}=41$

$\Rightarrow\ t_c=t_{41}=x+82=70+82=152$


$\therefore\ \text{Suma de cifras: }1+5+2=$\fbox{$8$}





\item En una mesa circular de siete sillas se sientan a dialogar cuatro obreros: $A,B,C,D$ y tres empleados: $X,Y,Z$. Se sabe que:

a. Ningún empleado se sienta junto a otro empleado.

b. $B$ se sienta junto a $D$, pero $Z$ no se sienta junto a ellos.

Determine cuál afirmación es siempre verdadera.
\begin{enumerate}[label=\Roman*.]
	\item Entre $D$ y $Z$ hay por lo menos 2 asientos.
	\item $X$ se sienta junto a $B$.
	\item $A$ se sienta junto a $Y$.
\end{enumerate}
\begin{enumerate}[label=\alph*)]
	\item Solo I
	\item I y II
...
\begin{center}
	\includegraphics[width=3cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/rm6c24-I.png}
\end{center}
...
\textbf{Noctámbulo} es la persona que \textbf{acostumbra estar despierta durante la noche} y realiza actividades en ese horario (por ejemplo, trabajar o caminar de madrugada). 
...
Entre las opciones, \textbf{Calcio : Cl} es incorrecto, porque su símbolo es \textbf{Ca}; \textbf{Rutenio : Rt} es incorrecto, porque su símbolo es \textbf{Ru}; \textbf{Plata : Og} es incorrecto, porque su símbolo es \textbf{Ag}; y \textbf{Oro : Ou} es incorrecto, porque su símbolo es \textbf{Au}.

Por lo tanto, la única pareja correctamente formada es \textbf{Fósforo : P}, de modo que la alternativa que mantiene la misma relación es la \textbf{a)}.
...
El texto de Alcmeón de Crotona explica la mortalidad como una consecuencia de la linealidad: el hombre muere porque no puede cerrar el ciclo de su existencia. Al no ser capaz de \textbf{enlazar} el principio con el fin, el ser humano queda atrapado o \textbf{confabulado} entre su \textbf{origen} y su \textbf{final}, siendo esta desconexión la que define su naturaleza finita. Por ello, el enunciado que mejor se adecúa es que el hombre está ligado inevitablemente a ambos extremos de su existencia.
...
\begin{center}
	\includegraphics[width=2.5cm]{imagenes/CEPRE-UNA2024-I/etapa1/ing/ingles1c24.png}
\end{center}
...
En la imagen se observan \textbf{nubes} y \textbf{gotas de lluvia} cayendo. Además, la persona sostiene un \textbf{paraguas}.

Estas señales indican que el clima está lluvioso.
...
Un adjetivo posesivo indica \textbf{pertenencia} o \textbf{posesión}. Algunos ejemplos son: \textit{my}, \textit{your}, \textit{his}, \textit{her}, \textit{its}, \textit{their} y \textit{our}.

En la alternativa \textbf{b)}, la palabra \textbf{Their} acompaña al sustantivo \textbf{names} e indica que los nombres les pertenecen a ellos
...
\begin{enumerate}[resume]
	...
	$x^2+(x^2+2ax+a^2)+2x \leq 1$

	$(x^2+x^2)+(2ax+2x)+a^2-1 \leq 0$
	
	$2x^2+2(a+1)x+a^2-1 \leq 0$
	
	Para que tenga una única solución, se debe cumplir:
	
	$\Delta = 0$
	
	Entonces:
	
	$\Delta = [2(a+1)]^2 - 4(2)(a^2-1)$
	
	$\Delta = 4(a^2+2a+1)-8(a^2-1)$
	
	$\Delta = 4(a^2+2a+1)-8a^2+8$
	...
	Por lo tanto, la suma de los valores de $a$ es:
...
\begin{enumerate}[resume]
	...
	\begin{center}
		\includegraphics[width=4cm]{imagenes/CEPRE-UNA2024-I/etapa1/bio/geo1c24-I.png}
	\end{center}
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=4cm]{imagenes/CEPRE-UNA2024-I/etapa1/bio/geo1c24-Ir.png}
		\end{minipage}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=4cm]{imagenes/CEPRE-UNA2024-I/etapa1/bio/geo2c24-I.png}
	\end{center}
	...
	\begin{center}
		\begin{minipage}{0.45\textwidth}
			...
			$m\wideparen{TKL}=2\alpha=4\beta+90^\circ$
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=4cm]{imagenes/CEPRE-UNA2024-I/etapa1/bio/geo2c24-Ir.png}
		\end{minipage}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=4.3cm]{imagenes/CEPRE-UNA2024-I/etapa1/bio/geo3c24-I.png}
	\end{center}
...
\begin{enumerate}[resume]
	...
	\begin{center}
		\includegraphics[width=3cm]{imagenes/CEPRE-UNA2024-I/etapa1/bio/trigo1c24-I.png}
	\end{center}
	...
	\begin{center}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=3cm]{imagenes/CEPRE-UNA2024-I/etapa1/bio/trigo1c24-Ir.png}
		\end{minipage}
	\end{center}
	...
	$1^g = \dfrac{360^\circ}{400} = \dfrac{9^\circ}{10}$
	
	Determinamos el error cometido:
	
	$E_{\text{error}}=\theta_{\text{verdadero}}-\theta_{\text{falso}}$
	
	$E_{\text{error}}=40^\circ-40^g$
	
	$E_{\text{error}}=40^\circ-40\left(\dfrac{9^\circ}{10}\right)$
	
	$E_{\text{error}}=40^\circ-36^\circ$
	
	$E_{\text{error}}=\boxed{4^\circ}$
...
\begin{enumerate}[resume]
	...
	$\dfrac{30N-25N}{1,000\ kg/m^3}=\dfrac{30N-20N}{\rho_{LD}}$
	
	$\dfrac{5N}{1,000\ kg/m^3}=\dfrac{10N}{\rho_{LD}}$
	
	$\rho_{LD}=\dfrac{1,000(10)}{5}\ kg/m^3$
	
	$\rho_{LD}=2,000\ kg/m^3$\\
	...
	\begin{center}
		\includegraphics[width=4.2cm]{imagenes/CEPRE-UNA2024-I/etapa1/bio/fisica3c24-I.png}
	\end{center}
...
\begin{enumerate}[resume]
	...
	$I.$ Se libera calor $\Rightarrow$ Verdadero
	
	$II.$ No es una reacción de descomposición $\Rightarrow$ Falso
	
	$III.$ Corresponde a una reacción de simple desplazamiento $\Rightarrow$ Verdadero
...
\begin{enumerate}[resume]
	...
	Durante la espermatogénesis, las espermátidas se originan tras la meiosis; sin embargo, estas aún no son células funcionales.
	
	La transformación de las espermátidas en espermatozoides ocurre en la etapa denominada espermiogenia, en la cual se producen cambios morfológicos y funcionales que permiten la formación de células maduras.
	
	Cabe señalar que espermiogenia y espermiogénesis son términos sinónimos utilizados en biología.
...
\begin{enumerate}[resume]
	...
	\item Juan Carlos se siente muy contento porque ingresó a la universidad; por otro lado se siente triste por sus amigos que no ingresaron. Esto refleja claramente la característica de la afectividad denominada:
	\begin{enumerate}[label=\alph*)]
		\item Amplitud
		\item Intensidad
		\item Polaridad
	...
	\item Después de varios años, Rosalia vuelve a la Universidad Nacional del Altiplano de Puno, pero manifiesta que nunca ha estado en aquel lugar. El texto mencionado refiere una anomalía de memoria denominada:
	\begin{enumerate}[label=\alph*)]
		\item Hipermnesia
		\item Agnosia
		\item Amnesia
...
\begin{enumerate}[resume]
	...
	\item La región natural comprendida entre los $2,300$ a $3,500$ m s.n.m. se denomina:
	\begin{enumerate}[label=\alph*)]
		\item Yunga
		\item Chala
		\item Suni
	...
	Según la clasificación de Javier Pulgar Vidal, la región \textbf{Quechua} se ubica aproximadamente entre los $2,300$ y $3,500$ m s.n.m.
...
\begin{enumerate}[resume]
	...
	\item El sacrificio de \textit{Titu Kusi Huallpa}, conocido como Cahuide, está relacionado con la rebelión de:
	\begin{enumerate}[label=\alph*)]
		\item Manco Cápac
		\item Calcu Chímac
...
\begin{enumerate}[resume]
	...
	La clasificación general de los tributos en el Perú son:
...
\begin{enumerate}[resume]
	...
	\item Un alumno comenta a su maestra sobre las dificultades que tuvo para llegar a la universidad a raíz de la inundación en algunas calles de la ciudad. El alumno, en este comentario, generó un texto narrativo de tipo:
	\begin{enumerate}[label=\alph*)]
		\item Fáctico
		\item Cotidiano
		\item Ficticio
...
\begin{enumerate}[resume]
	...
	\begin{center}
		\includegraphics[width=2cm]{imagenes/CEPRE-UNA2024-I/etapa1/bio/rm1c24-I.png}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=2cm]{imagenes/CEPRE-UNA2024-I/etapa1/bio/rm1c24-Ir.png}
	\end{center}
	...
	\begin{center}
		\begin{tikzpicture}[x=1.8cm,y=1.08cm]
			% marco
			...
			% nombres laterales
			\node[rotate=0] at (0.5,3.3) {Ana};
			\node[rotate=0] at (0.5,2.5) {Bety};
			\node[rotate=0] at (0.5,1.5) {Carol};
			\node[rotate=0] at (0.5,0.5) {Diana};
...
\begin{enumerate}[resume]
	...
	\item ¿Hayk'a chakiyuqtaq wakakunari/kanku? / Qawqha kayunisa wakaxa?
	\begin{enumerate}[label=\alph*)]
...
\begin{enumerate}
	...
	Por lo tanto, la estructura es: \fbox{$(\sim p \wedge \sim q) \rightarrow r$}
	...
	$\Rightarrow x = \dfrac{(144)(1)}{2.4} = 60$ litros.\\
	Debe adicionar: $60 - 48 =$\fbox{$ 12$ litros}
	...
	$n = \dfrac{150}{5} = 30$.\\
	Existen \fbox{ 30} múltiplos de 5.
...
\begin{enumerate}[resume]
	...
	\begin{center}
		\includegraphics[width=4.2cm]{imagenes/CEPRE-UNA2024-I/etapa1/soc/geo1c24-I.png}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=4cm]{imagenes/CEPRE-UNA2024-I/etapa1/soc/geo2c24-I.png}
	\end{center}
	...
	\textbf{Solucionario:}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=4cm]{imagenes/CEPRE-UNA2024-I/etapa1/soc/geo2c24-Ir.png}
		\end{minipage}
	\end{center}
...
\begin{enumerate}[resume]
	...
	\item Calcule:
	\[ M = \sqrt{\dfrac{\dfrac{3\pi}{4}rad + 40^g + 29^\circ}{2^\circ}} \]
	...
	\end{itemize}
	Reemplazando en $M$:
	\[ M = \sqrt{\dfrac{135^\circ + 36^\circ + 29^\circ}{2^\circ}} = \sqrt{\dfrac{200^\circ}{2^\circ}} = \sqrt{100} =\fbox{ 10 }\]
...
\begin{enumerate}[resume]
	...
	\begin{center}
	\includegraphics[width=4.2cm]{imagenes/CEPRE-UNA2024-I/etapa1/soc/fisica1c24-I.png}
	\end{center}
	...
	$ f_r = 40 \left( \dfrac{\sqrt{2}}{2} \right)\ N $
	
	$ f_r = $\fbox{$20\sqrt{2}\ N$} 
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=4cm]{imagenes/CEPRE-UNA2024-I/etapa1/soc/fisica2c24-I.png}
		\vspace{4mm}
	\end{minipage}
	\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=4cm]{imagenes/CEPRE-UNA2024-I/etapa1/soc/fisica2c24-II.png}
	\end{minipage}
\end{center}
...
\vspace{6mm}
	...
	Por tanto, la cantidad total de maneras es \(\boxed{1,120}\)
	...
	\item Habiéndose declarado una epidemia en un rebaño de alpacas, murió el 12\% del total, quedando tan solo 2,200 alpacas. ¿De cuántas alpacas constaba el rebaño?
	\begin{enumerate}[label=\alph*)]
		\item 2,300
		\item 2,350
		\item 2,400
	...
	$T = \dfrac{2,200}{0.88}=2,500$
	
	Entonces, el rebaño constaba de \(\boxed{2,500}\) alpacas.
...
\begin{enumerate}[resume]
	...
	En la imagen se observa a una persona leyendo un libro. Por ello, la descripción correcta es: \textbf{She was reading.}
...
\begin{enumerate}[resume]
	...
	La pregunta significa: \textbf{¿Cuál es un animal doméstico?}
	
	Entre las alternativas, \textbf{Misi / Phisi} corresponde al \textbf{gato}, que es un animal doméstico.
	
	Las demás opciones hacen referencia a animales silvestres.
...
\begin{enumerate}
	...
	\item Patricia quiere comprar un artefacto y el vendedor le ofrece un descuento del 10\% y un descuento adicional del 20\% por tener la tarjeta de la tienda. ¿Cuál es el descuento total que le ofrece a Patricia?
	\begin{enumerate}[label=\Alph*)]
		\item 29 \%
		\item 30 \%
		\item 28 \%
	...
	\item Luis desea obtener en 5 años S/50,000. Si la institución financiera le paga una tasa del 12\% simple anual, ¿cuánto debe depositar hoy para recibir ese monto en los 5 años?
	\begin{enumerate}[label=\Alph*)]
		\item S/ 25,000
		\item S/ 32,150
		\item S/ 33,150
	...
	\item El fin de semana, en un hospital, el número de visitas a los pabellones Materno Infantil y Gastroenterología fue $m+10n-3$ y $8m+5n+2$ respectivamente. Si $m$ es el término independiente del mínimo común múltiplo y $n$ es la suma de los coeficientes del máximo común divisor de los polinomios $P(x)=(x+2)(x+1)$ y $Q=x^2+4x+3$, ¿cuántas personas visitaron los pabellones mencionados el fin de semana?
	\begin{enumerate}[label=\Alph*)]
		\item 12
		\item 60
		\item 41
	...
	\item María tiene $a(a-1)-4$ años, donde $f(a)$ es el máximo valor de la función $f(x)=\dfrac{-x^3+4x^2+9x-6}{x+2}$. Determine la edad de María.
	\begin{enumerate}[label=\Alph*)]
		\item 63 años
		\item 24 años
		\item 26 años
	...
	\item Halle el área de la región triangular formada por los ejes coordenados y por la recta, cuya ecuación es:
	...
	\item Como se muestra la figura, un postulante a la UNA Puno tiene una estatura de 1.8 m. ¿Cuál es la altura del edificio?
	
	\begin{center}
		\includegraphics[width=4cm]{imagenes/propuestos/geometria2.png}
	\end{center}
	...
	\item De la figura calcule $5\sen\theta-1$.
	
	\begin{center}
		\includegraphics[width=3.5cm]{imagenes/propuestos/trigo1.png}
	\end{center}
	...
	\item Sea la función $f(x)=2-5\cos^2 x$, determine el rango.
	\begin{enumerate}[label=\Alph*)]
		\item $[-3;7]$
		\item $\langle -7;-3]$
	...
	\item Las resultantes máximas y mínimas de dos vectores son 8 y 2 unidades de magnitud, respectivamente. Halle el módulo de cada vector.
	\begin{enumerate}[label=\Alph*)]
		\item 13 y 8
		\item 1 y 4
		\item 6 y 2
	...
	\item Un tren de carga de Perú Rail tiene 100 m de longitud, viaja con una rapidez de 36 km/h y pasa por debajo de un puente. Un peatón observa que desde que ingresó el tren debajo del puente hasta que termina de salir demora 11 s. Calcular el ancho del puente.
	\begin{enumerate}[label=\Alph*)]
		\item 5 m
		\item 25 m
		\item 15 m
	...
	\item Se tiene 2 litros de ácido nítrico al 4 M. Determine el volumen de $H_2O$ que se debe agregar para obtener el mismo ácido al 1.5 N.
	\begin{enumerate}[label=\Alph*)]
		\item 3.3 L
		\item 2.3 L
		\item 3.0 L
	...
	\item En los siguientes compuestos químicos, marque la alternativa incorrecta.
	\begin{enumerate}[label=\Alph*)]
		\item $H_3PO_4$ : ácido fosfórico
		\item $K_2Cr_2O_7$ : dicromato de potasio
		\item $CH_3-CO-CH_3$ : acetona
		\item $K_2O_2$ : peróxido de potasio
		\item $CaSO_4\cdot 2H_2O$ : sulfato de calcio
	\end{enumerate}
	
	\item Corresponden a las funciones del intestino grueso:
	\begin{enumerate}[label=\Alph*)]
		\item Protección
		\item Hormonal
		\item Digestiva
		\item Difusión
		\item Producción de vitaminas
	\end{enumerate}
	
	\item Es un hueso de la cara:
	\begin{enumerate}[label=\Alph*)]
		\item Parietal
		\item Temporal
		\item Lagrimal
	...
	\item Para resolver problemas del área de matemáticas, Pablo recurre a fórmulas, en cambio su hermano menor Roberto utiliza sus dedos. Según Piaget, ¿en qué estadio se encuentra Pablo y Roberto, respectivamente?
	\begin{enumerate}[label=\Alph*)]
		\item Sensoriomotor-formal
		\item Formal-simbólico
		\item Concreto-sensorio motor
		\item Formal-concreto
		\item Preoperacional-sensorio motor
	\end{enumerate}
	
	\item Una estudiante pidió el número telefónico de la secretaria académica para realizar consultas; luego que llamó y absolvió sus dudas, olvidó el número telefónico porque ya no lo necesitaba. Este hecho representa el tipo de memoria:
	\begin{enumerate}[label=\Alph*)]
		\item Sensorial
		\item De largo plazo
		\item De corto plazo
		\item Permanente
		\item De mediano plazo
	\end{enumerate}
	...
	\item Si alguna autoridad vulnera o amenaza la libertad individual, se puede interponer la garantía constitucional denominada:
	\begin{enumerate}[label=\Alph*)]
		\item Habeas data
		\item Habeas corpus
		\item Acción popular
	...
	\item Es el precursor del cooperativismo que, de manera general, sostenía que, frente a la explotación y desorden, el gobierno debería encargarse a una “élite” formada por comerciantes e industriales, por sabios y técnicos.
	\begin{enumerate}[label=\Alph*)]
		\item Philip Bouchez
		\item Joseph Proudhon
		\item Robert Owen
		\item Luis Blanc
		\item Saint Simon
	\end{enumerate}
	
	\item En las antiguas obras griegas, la autoría pasaba a un segundo plano, porque:
	\begin{enumerate}[label=\Alph*)]
		\item Existía dominio del mito de los dioses sobre los hombres.
		\item Las historias trasmitidas oralmente eran de voces colectivas.
		\item Al pasar las historias de la oralidad a la escritura, hubo confusión autoral.
		\item Se centraba en destacar la función actancial del héroe.
		\item La historia es un tejido de historias yuxtapuestas con el tiempo.
	\end{enumerate}
	
	\item En la expresión de “Canción de otoño en primavera”: “Era una dulce niña, en este / mundo de sueño y aflicción”, la figura modernista presente es:
	\begin{enumerate}[label=\Alph*)]
		\item sinestesia
		\item símbolo
		\item símil
	...
	\end{enumerate}
		...
		\item Se establece como condición que la cantidad demandada de un bien o servicio depende de la dinámica económica de la población; el consumo en las zonas urbano marginales, donde el nivel de ingresos es bajo, aumenta debido a:
	\begin{enumerate}[label=\Alph*)]
		\item Estancamiento de la producción y aumento de la población.
		\item Estabilización de los precios y reducción de los sueldos.
		\item Aumento de la inflación y emisión del dinero.
		\item Reducción de los precios e incremento del nivel del empleo.
		\item Aumento del precio y reducción del nivel del empleo.
	\end{enumerate}
	
	\item Las unidades económicas privadas están conformadas por:
	\begin{enumerate}[label=\Alph*)]
		\item familias y empresas
		\item empresas y gobierno
		\item familias y gobierno
		\item gobierno y el exterior
		\item empresas y el exterior
	\end{enumerate}
	
	\item El Ministerio de Desarrollo e Inclusión Social, encargado de mejorar la calidad de vida en los peruanos en extrema pobreza y fomentar la equidad, proteger a poblaciones vulnerables y en estado de abandono, fue creado durante el gobierno de:
	\begin{enumerate}[label=\Alph*)]
	...
	\item En la arquitectura romana desarrollada por sus ingenieros; hicieron obras de arte, destacando las construcciones religiosas. De los siguientes enunciados indicar cuál no es una característica.
	\begin{enumerate}[label=\Alph*)]
		\item Usan el movimiento del arco, la bóveda y la cúpula.
		\item Construyen empleando cuatro sistemas de aparejo.
		\item Crean la simetría horizontal en el edificio.
		\item Crean la planta basilical, el ábside que prolonga la nave central.
		\item Usaron los estilos dórico, jónico y corinto en sus templos.
	\end{enumerate}
	
	
	\item El lado de un hexágono regular mide 7 m. Determinar cuánto mide el lado de otro hexágono cuya área es $\dfrac{3}{7}$ del área del primer hexágono.
	\begin{enumerate}[label=\Alph*)]
		\item $\sqrt{28}$ m
		\item $\sqrt{20}$ m
		\item $\sqrt{22}$ m
	...
	\item Indicar qué letra continúa en la siguiente serie:
	
	$B,\ Q,\ P,\ C,\ S,\ R,\ D,\ U,\ \ldots$
	...
	\item Elegir la alternativa que contenga el orden de las ideas del siguiente proceso:
	...
	\item Marcar la palabra que no pertenece al grupo.
	\begin{enumerate}[label=\Alph*)]
		\item Vaso
		\item Botijo
		\item Copa
	...
	\item Riqsichisqayki: ¿Imanalla kachkanki?
	\begin{enumerate}[label=\Alph*)]
		\item Allin p’unchay
		\item Suma urmana
		\item Ñawpaqta
	...
	\item ¿Iman llamk’ay ñuqayku kay qillqakunapi kanki?
	\begin{enumerate}[label=\Alph*)]
		\item Chay
		\item Ñuqa
		\item Uka
	...
	\item She \_\_\_\_\_\_\_\_ to the gym every morning.
	\begin{enumerate}[label=\Alph*)]
		\item Go
		\item Goes
		\item Gone
	...
	\item Can he swim? --- Yes, \_\_\_\_\_.
	\begin{enumerate}[label=\Alph*)]
		\item He can
		\item He do
		\item He does
...
\begin{center}
	\begin{tabular}{ll ll ll ll ll ll}
		...
		7) E & 8) E & 9) D & 10) D & 11) A & 12) E \\
		13) E & 14) C & 15) D & 16) C & 17) D & 18) E \\
		19) B & 20) E & 21) B & 22) D & 23) D & 24) A \\
		25) C & 26) C & 27) D & 28) C & 29) A & 30) D \\
		31) D & 32) B & 33) B & 34) A  & & \\
	\end{tabular}
\end{center}
